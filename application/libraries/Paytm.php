...
class Paytm
{
    ...
    public function __construct($config = array())
    {
        ...
        if (PAYTM_ENVIRONMENT == 'PROD') {
            ...
            $PAYTM_MERCHANT_MID = "lsZgPM13432918263548";
            $PAYTM_MERCHANT_KEY = "vc#6hs33bCk9YTvU";

            $PAYTM_CHANNEL_ID = "WEB";
            $PAYTM_INDUSTRY_TYPE_ID = "Retail";
            $PAYTM_MERCHANT_WEBSITE = "DEFAULT";

            $PAYTM_CALLBACK_URL = base_url() . "Checkout/paytm_response";
        } else {
            //===================================================
            ...
            $PAYTM_MERCHANT_MID = "adsGsL25749480677323";
            $PAYTM_MERCHANT_KEY = "9@AkD_e_vi%%@iBr";

            $PAYTM_CHANNEL_ID = "WEB";
            $PAYTM_INDUSTRY_TYPE_ID = "Retail";
            $PAYTM_MERCHANT_WEBSITE = "DEFAULT";

            $PAYTM_CALLBACK_URL = base_url() . "/Myaccount/paytm_response";
        }
