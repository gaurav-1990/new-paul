<main class="main-container">
    ...
    <div class="panel panel-white">
        ...
        <?= $this->session->flashdata('img'); ?>
        <div class="panel-body  pb">
            <?php
            $output = '';
            $output .= form_open_multipart('Admin/UploadInvoice/save');
            $output .= '<div class="row">';

            $output .= '<div class="col-lg-3 col-sm-4"><div class="form-group">';

            $output .= form_label('Add Product', 'image');
            $data = array(
                'name' => 'userfile',
                'id' => 'userfile',
                'class' => 'form-control ',
            ...
            // $output .= anchor(base_url("assets/test31.xlsx"), 'Download Sample', 'class="btn btn-xs btn-success"');
