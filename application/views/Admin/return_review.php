                            ...
                            <div class="table-responsive">
                                ...
                                <table id='example' class="table table-bordered table-striped table-nowrap no-mb">
                                    ...
                                    <tbody>
                                        ...
                                        $count = 1; 
                                           foreach($returnodr as $orderSS)  { 
                                            if($returnodr != ''){
                                               $speceficOrder = getOrder($orderSS->return_order_id);
                                            //    echo "<pre>";
                                            //    print_r($speceficOrder);
                                            //    echo "</pre>";   
                                            ...
                                            if ($orderSS->pay_method == 0) {
                                                $pay_method = "COD";
                                            } else if ($orderSS->pay_method == 1) {
                                                $pay_method = "Online";
                                            } else if ($orderSS->pay_method == 2) {
                                                $pay_method = "Wallet";
                                            } else if ($orderSS->pay_method == 3) {
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $orderSS->user_email ?> <br> <?= $orderSS->user_contact ?></td>
                                               

                                                <td><?= $pay_method ?></td>
                                                <td><?= $orderSS->refund==1?"In Account":"Wallet"; ?></td>
                                                <td style="white-space: pre-wrap"><?=  $orderSS->return_account ?></td>
                                                <td style="white-space: pre-wrap"><?= $orderSS->comment ?></td>
                                                <td><?= $ost ?></td>                                                                                     
                                                ...
                                                <td><?= $orderSS->return_cause ?></td>

                                                <td><img src=<?=base_url('return_image/'.$orderSS->images);?> width='60px' height='60px'></td>
