                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="panel  panel-white">
                        <div class="panel-body">
                            <?=form_open_multipart('Admin/SadminLogin/offercode', array('method' => 'POST', 'id' => 'sform2', 'class' => 'sform2'))?>
                            <div class="panel-body  pb">
                                <div class="row">
                                    <div class="col-sm-3">
                                        <label>Offer Name</label>
                                        <input type="text" id="offer_name" name="offer_name" class="form-control"
                                            placeholder="Offer Name" value="" autocomplete="off" required />
                                    </div>
                                    <div class="col-sm-3">
                                        <label>Offer Code</label>
                                        <input type="text" id="offer_code" name="offer_code" class="form-control"
                                            placeholder="Offer Code" value="" autocomplete="off" required />
                                    </div>
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <input type="text" id="offer_val" name="offer_val" class="form-control"
                                            placeholder="Offer Value" value="" autocomplete="off" required />
                                    </div>
                                </div>
                            </div>
                            <div class="panel-body  pb">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <input type="text" id="offer_per_customer" name="offer_per_customer"
                                            class="form-control" placeholder="Offer Customer" value="0"
                                            autocomplete="off" />
                                    </div>
                                    <div class="col-sm-3">
                                        <label>From Date </label>
                                        <input type="text" id="offer_validity_from" name="offer_validity_from"
                                            class="form-control" placeholder="Offer From" value="" autocomplete="off" />
                                    </div>
                                    <div class="col-sm-3">
                                        <label>To Date</label>
                                        <input type="text" id="offer_validity_to" name="offer_validity_to"
                                            class="form-control" placeholder="Offer To" value="" autocomplete="off" />
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <input type="text" id="priority" name="priority"
                                            class="form-control" placeholder="Priority" autocomplete="off" />
                                    </div>
                                    <div class="col-sm-4">
                                    ...
                                    <div class="col-sm-2 which_price">
                                        ...
                                        <select class="form-control" name="which_price" id="which_price" required>
                                            ...
                                            <option value="1">Grand-Total</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-sm-1">
                                        ...
                                        <input type="text" id="min_val" name="min_val" class="form-control"
                                            placeholder="Min Value" value="0" autocomplete="off" />
                                    </div>

                                    <div class="col-sm-1">
                                        <label>Per Value</label>
                                        <input type="checkbox" id="per_val" name="per_val" checked value="1"/>
                                    </div>
                                </div>
                            </div>
...
$sub_categories = getSubCate_Byid($category->id);
    ?>
                                                                        <ul class="nav">
                                                                            ...
                                                                            <li><a><input type='checkbox' id="category" value="<?=$sub->id?>" name='sub_cat[]' /><?=$sub->sub_name?></a>
                                                                            </li>
                                                                            <?php }?>
                                                                        </ul>
                                                                    </div>
                    ...
                    <div class="panel-body  pb">
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <input type="submit"  value="Add Offer Code" class="btn btn-xs btn-success">
                            </div>
                        </div>
