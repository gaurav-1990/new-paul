<main class="main-container">
    ...
    <div class="panel panel-white">
        ...
        <div class="panel-body  pb">
            <?php
            $output = '';
            $output .= form_open_multipart('Admin/ColorUpload/save');
            $output .= '<div class="row">';

            $output .= '<div class="col-lg-3 col-sm-4"><div class="form-group">';

            $output .= form_label('Add Colors', 'image');
            $data = array(
                'name' => 'userfile',
                'id' => 'userfile',
                'class' => 'form-control ',
            ...
            $output .= "<br>";
            // $output .= anchor(base_url("assets/colorcode5.csv"), 'Download Sample', 'class="btn btn-xs btn-success"');
            $output .= '</div></div>';
