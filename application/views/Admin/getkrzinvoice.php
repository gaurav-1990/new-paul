...
<?php
$offer_code = "";
$offerId = getOfferDetails($data[0]->offer_id);

$offer_value = $data[0]->total_offer;
...
<head>
    ...
    <title>Invoice PAUL/2020-21/<?= $data[0]->order_id ?></title>
    <style type="text/css">
        @media print {
...
<body style="font-family: Roboto, 'Segoe UI', Tahoma, sans-serif;font-size: 14px;">
    ...
    <table width="80%" style="margin:0 auto; ">
        ...
        <tr>
            ...
            <td colspan="4" style="text-align: right;padding-right: 8px;"> <span style="border: 1px dashed #777;padding: 3px;">Invoice Number: PAUL/<?= $invoice_date ?>/<?= $data[0]->order_id ?></span> </td>
        </tr>
        ...
        <tr>
            <td style="font-size: 13px" colspan="2"><b>GSTIN -</b> 06AAOPP2964N1ZY </td>
            <td colspan=""> </td>
        ...
        // if($val->bag_ship_confirm == 1){
        //     $shipping_charge = $val->bag_ship_amt;
        // }else {  
        //     $shipping_charge = $val->shipping;
       ...
       ?>
        ...
        <tr>
            ...
            <td style="text-align: right;border-top: 1px solid #000;padding:0;margin: 0" colspan="4">
                <?php if ($data[0]->pay_method != "cash") { ?>
                    ...
                    <h4 style="padding:0;margin: 0"> <?= "Shipping Charges: " ?><?=$mode?> </h4>
        ...
        <tr>
            ...
            <td colspan="4" style="<?= $data[0]->pro_act_p == $data[0]->pro_price ? ('text-align: right;border-bottom: 1px solid #000;border-top: 1px solid #000;padding:0') : 'text-align: right;border-top: 1px solid #000;padding:0' ?>">
                <h3 style="padding:0;margin: 0"> INR <?= round(round($grand) + round($shipping_charge) - $offer_value + $data[0]->gift_price); ?></h3>
            </td>
        ...
        <tr>
            ...
            <td colspan="2" style="text-align: center"> <img width="350" height="250" src="<?= base_url('uploads/signature/') ?><?= $data[0]->signature ?>" alt="vendor signature" /> </td>
        </tr>
        <tr>
            <td colspan="6"></td>
