...
class BarcodeGeneratorHTML extends BarcodeGenerator
{
    ...
    public function getBarcode($code, $type, $widthFactor = 2, $totalHeight = 30, $color = 'black')
    {
        ...
        $html = '<div style="font-size:0;position:relative;height:' . ($totalHeight) . 'px;">' . "\n";
        ...
        foreach ($barcodeData['bars'] as $bar) {
            ...
            if ($bar['drawBar']) {
                ...
                // draw a vertical bar
                $html .= '<div style="background-color:' . $color . ';width:' . $barWidth . 'px;height:' . $barHeight . 'px;position:absolute;right:' . $positionHorizontal . 'px;top:' . $positionVertical . 'px;">&nbsp;</div>' . "\n";
            }
