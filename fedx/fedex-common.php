...
function getProperty($var){
  ...
  if($var == 'key') Return 'uGYaaBxdfozHtPuC'; 
	if($var == 'password') Return 'uGYaaBxdfozHtPuC'; 
	if($var == 'parentkey') Return 'uGYaaBxdfozHtPuC'; 
	if($var == 'parentpassword') Return 'Fedex1234'; 
  ...
  if($var == 'shipdate') Return '2018-05-08';
	...
	if($var == 'trackingnumber') Return '449044304137821';
